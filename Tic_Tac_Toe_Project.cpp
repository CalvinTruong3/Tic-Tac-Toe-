...
int main(void)
{
	...
	cout << "Instructions: You will be playing as 'X'. The CPU will be playing as 'O'. Enter two numbers from 1-3 followed by a space";
	cout << " in between. (Ex: 1 2) \n" << endl;
	while (CONTINUE)
	{
		done = ' ';
		init_matrix();
...
//Looks for all of the possible outcome of the user winning the game
bool vulnerable(int mat[3][3])
{
...
//Looks for all of the possible outcome of the computer winning the game
bool winnable(int mat[3][3])
{
	char a, b, c, d, e, f, g, h, i;
	a = mat[0][0], b = mat[0][1], c = mat[0][2];
...
//Looks for the to see if the spaces are all filled out before ending the game
bool finish(int mat[3][3])
{
	for (int i = 0; i < 3; ++i)
	{
